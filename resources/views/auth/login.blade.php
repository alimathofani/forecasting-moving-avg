                ...
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('login') }}" class='user'>
                        ...
                        <div class="form-group">
                            <input id="email" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Enter Email Address..." name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
                        ...
                        <hr>
                        <div class="text-center">
                            <a class="btn btn-success btn-user btn-block" href="{{ route('register') }}">{{ __('Register') }}</a>
                        </div>
                    </form>
                </div>
                </div>
